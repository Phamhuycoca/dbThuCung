...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dbThuCung.Model.Entities.CartItem", b =>
                {
                    b.Property<long>("CartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("CartItemId"), 1L, 1);
            ...
            modelBuilder.Entity("dbThuCung.Model.Entities.CartItem", b =>
                {
                    b.HasOne("dbThuCung.Model.Entities.NguoiDung", "NguoiDung")
                        .WithMany("getCartItem")
                        .HasForeignKey("NguoiDungId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("dbThuCung.Model.Entities.SanPham", "SanPham")
                        .WithMany("CartItem")
